...
s_arm_l = ["hand_ik_hinge.L", "hand_fk.L", "arm.L", "arm_fix.L", "elbow_fix.L", "arm_twist.L", "forearm_twist.L", "wrist_fix_low.L", "wrist_fix_up.L"]
s_arm_r = ["hand_ik_hinge.R", "hand_fk.R", "arm.R", "arm_fix.R", "elbow_fix.R", "arm_twist.R", "forearm_twist.R", "wrist_fix_low.R", "wrist_fix_up.R"]
